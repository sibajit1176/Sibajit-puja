                    ...
                    >
                        <motion.div
                            className="
                                ...
                                -inset-y-5
                                rounded-full
                                bg-[radial-gradient(ellipse,rgba(255,190,90,0.12),rgba(60,220,220,0.06),transparent_70%)]
                                blur-2xl
                            "
                            animate={{
                        ...
                        <span
                            className="
                                ...
                                text-[10px]
                                text-amber-200
                                drop-shadow-[0_0_7px_rgba(255,210,100,0.8)]
                            "
                        >
                            ✦
                        </span>
                            ...
                            {"Happy".split("").map((letter, index) => (
                                <motion.span
                                    ...
                                    style={{
                                        ...
                                        textShadow:
                                            "0 0 5px rgba(255,230,150,0.8), 0 0 12px rgba(255,190,80,0.45)",
                                    }}
                                    initial={{
                                        opacity: 0,
                                        y: 12,
                            ...
                            {"Birthday".split("").map((letter, index) => (
                                <motion.span
                                    ...
                                    style={{
                                        ...
                                        textShadow:
                                            "0 0 5px rgba(190,255,245,0.85), 0 0 12px rgba(70,220,210,0.5)",
                                    }}
                                    initial={{
                                        opacity: 0,
                                        y: 12,
                        ...
                        <motion.span
                            className="
                                ...
                                text-[22px]
                                leading-none
                                drop-shadow-[0_0_10px_rgba(255,210,100,0.8)]
                            "
                            animate={{
                                y: [0, -3, 0],
                                rotate: [-3, 3, -3],
                        ...
                        <motion.span
                            className="
                                ...
                                leading-none
                                text-rose-300
                                drop-shadow-[0_0_10px_rgba(255,100,170,0.8)]
                            "
                            animate={{
                                scale: [1, 1.2, 1],
                            }}
                        ...
                        <span
                            className="
                                ...
                                text-[10px]
                                text-cyan-200
                                drop-shadow-[0_0_7px_rgba(80,230,230,0.8)]
                            "
                        >
                            ✦
                        </span>
                    ...
                    >
                        <div
                            className="
                                ...
                                -inset-y-8
                                rounded-full
                                bg-[radial-gradient(ellipse,rgba(255,45,185,0.24),transparent_68%)]
                                blur-2xl
                            "
                        />
                        ...
                        <div className="relative z-10 flex items-center justify-center">
                            <motion.h2
                                ...
                                style={{
                                    ...
                                    textShadow:
                                        "0 0 6px rgba(255,230,248,0.9), 0 0 15px rgba(255,90,195,0.65), 0 0 28px rgba(255,40,180,0.4)",
                                }}
                                animate={{
                                    opacity: [0.88, 1, 0.88],
                                    y: [0, -2, 0],
                            ...
                            <motion.span
                                ...
                                style={{
                                    textShadow:
                                        "0 0 8px rgba(255,130,220,1), 0 0 20px rgba(255,50,190,0.8), 0 0 35px rgba(255,30,180,0.5)",
                                }}
                                animate={{
                                    scale: [1, 1.15, 1],
                                    rotate: [0, -5, 5, 0],
